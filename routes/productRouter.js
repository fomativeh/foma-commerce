...
productRouter.post("/create", multerMiddleware, productAuth, productController.create);
productRouter.get("/single/:productId", productController.fetchSingle);
productRouter.delete("/:productId", productAuth, productController.deleteSingle);
